...
namespace nat20sDD
{
	public partial class BattlePage : ContentPage
	{
		public BattlePage(Game game)
		{
            ...
            var battleResultButton = new Button
            {
                Text = "Show Battle Results",
            };
            battleResultButton.Clicked += delegate
            {
            ...
            bool heroLive = game.heroTeamLives();
            bool monsLive = game.monsterTeamLives(game.battle.monsters);
            if ( !monsLive)
            {
                DisplayAlert("Victory!", "You have slain all the monsters.", "OK");
                battle.Children.Add(battleResultButton);
                battle.Children.Add(nextBattleBtn);
            }
            else if (!heroLive)
            {
                DisplayAlert("Game Over!", "Your heroes have been killed.", "OK");
